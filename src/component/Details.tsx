      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="overflow-hidden fixed h-screen z-50 top-0 right-0 -translate-x-1/2 w-[70%] md:w-[45%] lg:w-[45%] xl:w-[40%] py-2 lg:py-4 px-2 lg:px-4 flex-col items-start justify-center bg-white"
          >
            <div className="w-full h-full flex flex-col items-center justify-start bg-gradient-to-r from-white/20 via-gline/20 to-white/20">
              <div className="py-3 px-3 bg-gradient-to-b from-gtop to-gdown h-2/5 w-full rounded-2xl">
                <div
                  onClick={() => setOpen(false)}
